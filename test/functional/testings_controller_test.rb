...
class TestingsControllerTest < ActionController::TestCase
  ...
  test "should create testing" do
    assert_difference('Testing.count') do
      post :create, testing: { request_comment: @testing.request_comment, requested_at: @testing.requested_at, test_comment: @testing.test_comment, test_passed_yn: @testing.test_passed_yn, tested_at: @testing.tested_at }
    end
  ...
  test "should update testing" do
    put :update, id: @testing, testing: { request_comment: @testing.request_comment, requested_at: @testing.requested_at, test_comment: @testing.test_comment, test_passed_yn: @testing.test_passed_yn, tested_at: @testing.tested_at }
    assert_redirected_to testing_path(assigns(:testing))
  end
